...
C_SRCS += \
G:/Work/OSrc/K6xNetworkDemo/Code/platform/hal/src/rnga/fsl_rnga_hal.c 

OBJS += \
./platform/rnga/hal/fsl_rnga_hal.o 

C_DEPS += \
./platform/rnga/hal/fsl_rnga_hal.d 


# Each subdirectory must supply rules for building sources it contributes
platform/rnga/hal/fsl_rnga_hal.o: G:/Work/OSrc/K6xNetworkDemo/Code/platform/hal/src/rnga/fsl_rnga_hal.c
	@echo 'Building file: $<'
