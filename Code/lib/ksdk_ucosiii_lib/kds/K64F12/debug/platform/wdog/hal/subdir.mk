...
C_SRCS += \
G:/Work/OSrc/K6xNetworkDemo/Code/platform/hal/src/wdog/fsl_wdog_hal.c 

OBJS += \
./platform/wdog/hal/fsl_wdog_hal.o 

C_DEPS += \
./platform/wdog/hal/fsl_wdog_hal.d 


# Each subdirectory must supply rules for building sources it contributes
platform/wdog/hal/fsl_wdog_hal.o: G:/Work/OSrc/K6xNetworkDemo/Code/platform/hal/src/wdog/fsl_wdog_hal.c
	@echo 'Building file: $<'
