...
#include "NetCommon.h"
/**
 * @brief Tạo các Thread, init các thông số
 * 
 * @return int 
 */
 ...
 * @return NetStatus 
 */
NetStatus Net_TCPClientSendCmd(const uint8_t *data, uint32_t length);
/**
 * @brief 
 * 
 * @param data 
 ...
 * @return NetStatus 
 */
NetStatus Net_TCPServerSendCmdToAllClient(const uint8_t *data, uint32_t length);